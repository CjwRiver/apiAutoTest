...
class BaseRequest(object):
    ...
    def send_request(cls, case: list, ysxpre: str = 'ysxpre') -> object:
        ...
        url = ReadFile.read_config(f'$.server.{ysxpre}') + DataProcess.handle_path(path)
        ...
        if token == '写':
            ...
            DataProcess.have_token['a872107e9fb26fb46833a547761e6d26'] = extractor(res.json(), ReadFile.read_config('$.expr.token'))
